...
type BuildUsersQueryModelParams = {
  users: UserListItem[]
  isForbidden: boolean
 ...
 * @returns 編集フォーム初期値
 */
function buildInitialEditForm(): UsersEditForm {
  return {
    name: '',
    email: '',
    password: '',
 ...
 * @returns 新規作成フォーム初期値
 */
function buildInitialCreateForm(): UsersCreateForm {
  return {
    name: '',
    email: '',
    password: '',
...
/**
 * @description query表示用のモデルを作成する
 * @param params query表示に必要な入力値
 * @returns query表示モデル
 */
function buildUsersQueryModel(params: BuildUsersQueryModelParams): UsersQueryModel {
  return {
    users: params.users,
    // アクション失敗を優先して、なければ初回取得エラーを表示する
    errorMessage: params.actionErrorMessage || params.queryErrorMessage,
 ...
 * @returns 編集モデル
 */
function buildUsersEditModel(params: BuildUsersEditModelParams): UsersEditModel {
  /**
 ...
 * @returns 新規作成モデル
 */
function buildUsersCreateModel(params: BuildUsersCreateModelParams): UsersCreateModel {
  /**
 ...
 */
function buildUsersActionModel(params: BuildUsersActionModelParams): UsersActionModel {
  /**
